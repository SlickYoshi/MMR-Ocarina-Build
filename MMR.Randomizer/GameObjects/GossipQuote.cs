...
namespace MMR.Randomizer.GameObjects
{
    public enum GossipQuote
    {
        ...
        [GossipRestrict(GossipRestrictAttribute.RestrictionType.Location, Item.SongTime)]
        [GossipRestrict(GossipRestrictAttribute.RestrictionType.Location, Item.ItemOcarina)]
