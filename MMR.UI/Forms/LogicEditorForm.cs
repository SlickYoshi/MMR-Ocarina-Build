...
namespace MMR.UI.Forms
{
    public partial class LogicEditorForm : Form
    {
        ...
        "Ocarina of Time", "Song of Time", "Song of Healing", "Song of Soaring", "Epona's Song", "Song of Storms", "Sonata of Awakening", "Goron Lullaby", "New Wave Bossa Nova",
        ...
        private void LoadLogic(string logicString)
        {
            ...
            while (true)
            {
                ...
                else
                {
                    ...
                    string[] trickInfo = lines[i + 4].Split(new char[] { ';' }, 2);
